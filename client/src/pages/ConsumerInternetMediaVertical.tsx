...
export default function ConsumerInternetMediaVertical() {
  const metrics = [
    { value: "$500B+", label: "Global Consumer Internet Sector", sublabel: "attention-rich, belief-poor" },
    { value: "80%", label: "Platforms Stall", sublabel: "after early adoption without signal" },
    { value: "2–3x", label: "Higher Retention", sublabel: "with trust and inevitability" },
    { value: "50%", label: "Faster Funding", sublabel: "when attention becomes conviction" }
  ];

  const approachSteps = [
    {
      title: "1) Diagnose",
      description: "Audit the credibility gap: attention vs. retention, engagement vs. inevitability, traction vs. capital belief."
    },
    {
      title: "2) Architect",
      description: "Reframe story around inevitability: why the platform is not just engaging but unstoppable. Align narratives for users, creators, partners, and investors."
    },
    {
      title: "3) Activate",
      description: "Design funnels and adoption signals that turn noise into traction, traction into trust, and trust into capital."
    }
  ];
  ...
  const services = [
    {
      ...
      description: "Reframe platforms beyond noise into inevitability.",
    ...
    {
      title: "Fund Raising",
      description: "Capital signals that show durable retention and monetization.",
    ...
    {
      title: "GTM & Funnels",
      description: "Funnels that convert traffic into habit and transactions.",
    ...
    },
    {
      ...
      description: "Advisory on partnerships, creator ecosystems, and global expansion.",
  ...
  const testimonials = [
    {
      quote: "We had millions of users but no conviction. Instaura rebuilt us as inevitable — funding followed.",
      author: "Founder — Marketplace Startup"
    },
    {
      quote: "Our creator churn stopped once the narrative shifted to belief. Signal changed retention.",
      author: "CEO — Creator Economy Venture"
    },
    {
      quote: "Investors dismissed us as hype. Signal reframed us as infrastructure. That closed the round.",
      author: "Co-Founder — Media Platform"
    }
  ];
    ...
    <div className="pt-16 bg-white text-gray-800">
      ...
      <header className="bg-gray-50 px-6 py-3 text-sm">
        <div className="max-w-6xl mx-auto text-gray-600">
          ...
          <span className="text-gray-900 font-medium ml-1">Consumer Internet & Media</span>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Consumer Internet & Media <span className="text-brand-red">Signal</span>. Attention Is Noise. Belief Is Signal.
            </h1>
            <p className="mt-3 text-sm text-gray-500">
              Subsectors: <span className="font-medium text-gray-700">Marketplaces, Content Platforms, Creator Economy, Gaming, and more</span>
            </p>
            <p className="mt-4 text-lg text-gray-700">
              In consumer internet, noise is abundant but belief is scarce. Signal turns attention into traction, and traction into inevitability.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow p-5 hover:shadow-md hover:scale-105 transition-all duration-300">
            <h3 className="text-sm font-semibold mb-2">Where we create decisive movement</h3>
            <ul className="text-sm text-gray-700 space-y-1 list-disc ml-5">
              <li>Marketplace → reframed beyond traffic, closed growth funding</li>
              <li>Creator platform → repositioned as infrastructure, retained creators</li>
              <li>Gaming startup → recoded for inevitability, attracted strategic capital</li>
            </ul>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4 text-gray-800">
                <p><strong>Users ≠ believers:</strong> Platforms scale quickly in numbers but fail to turn those users into durable belief.</p>
                <p><strong>Engagement ≠ inevitability:</strong> High DAUs or MAUs don't guarantee capital or partner confidence.</p>
                <p><strong>Monetization gap:</strong> Many startups attract users but fail to signal durable economics.</p>
                <p><strong>Noise trap:</strong> Consumer internet plays drown in features, promotions, and hype, while the signal of inevitability gets lost.</p>
              </div>
              <div className="group bg-white rounded-3xl border-2 border-white/60 p-8 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl hover:scale-105 hover:border-brand-red/30 transition-all duration-500">
                ...
                <ul className="list-disc ml-5 space-y-2 text-gray-700">
                  <li>Marketplaces focused on traffic, not inevitability of transactions</li>
                  <li>Content platforms scaling views, but losing creator loyalty</li>
                  <li>Creator economy ventures missing credibility with capital</li>
                  <li>Gaming startups focused on DAUs, not belief in long-term scale</li>
                </ul>
                <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden mt-4">
                  <div className="h-full bg-gradient-to-r from-brand-red to-red-600 w-0 group-hover:w-full transition-all duration-700"></div>
                </div>
      ...
      <ScrollReveal>
        <section id="services" className="px-6 py-10 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Services for Consumer Internet & Media</h2>
          ...
          <div className="max-w-6xl mx-auto rounded-2xl border p-8 shadow-sm bg-white hover:shadow-md hover:scale-105 transition-all duration-300">
            <div className="md:flex md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-gray-600 mt-2">See how Signal changed outcomes in Consumer Internet & Media.</p>
              </div>
              <div className="flex flex-wrap gap-2 mt-4 md:mt-0">
                <Link href="/insights?vertical=consumer-internet-media">
      ...
      <section className="px-6 py-14 bg-brand-dark text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h3 className="text-2xl font-semibold mb-3">Every decisive consumer move begins with Signal.</h3>
          <p className="text-gray-300">Attention is temporary. Signal builds inevitability.</p>
