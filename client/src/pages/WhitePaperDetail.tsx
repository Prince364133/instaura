        ...
        <div className="bg-white text-gray-900 font-sans">
            ...
            <div className="bg-gray-50 px-6 py-3 text-sm">
                <div className="max-w-7xl mx-auto text-gray-600">
                    ...
                    <Link href="/white-papers" className="hover:underline">White Papers</Link> /{" "}
                    ...
                    <aside className="lg:col-span-4 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <div className="font-semibold">{paper.category} • {paper.service}</div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div className="font-semibold">Digital • Long-form</div>
                            </div>
                        </div>
                        <div className="mt-6 pt-6 border-t border-gray-100 grid grid-cols-2 gap-3">
                            <div className="text-center rounded-xl border border-gray-100 bg-gray-50 p-3">
                                <div className="text-xl font-extrabold text-brand-red">18</div>
                                <div className="text-[10px] uppercase text-gray-500 mt-1 font-medium">Years</div>
                            </div>
                            <div className="text-center rounded-xl border border-gray-100 bg-gray-50 p-3">
                                <div className="text-xl font-extrabold text-brand-red">250+</div>
                                <div className="text-[10px] uppercase text-gray-500 mt-1 font-medium">Movements</div>
                            </div>
                        </div>
                    </aside>
                </div>
