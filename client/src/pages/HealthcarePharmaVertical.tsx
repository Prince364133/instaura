...
export default function HealthcarePharmaVertical() {
  const metrics = [
    { value: "8–15%", label: "YoY Adoption", sublabel: "by subcategory & region" },
    { value: "12–24 mo", label: "Validation Cycle", sublabel: "enterprise procurement" },
    { value: "30–50%", label: "Faster Pilots", sublabel: "when signal aligns" },
    { value: "2–4x", label: "Conversion Lift", sublabel: "explicit econ value" }
  ];

  const approachSteps = [
    {
      title: "1) Diagnose",
      description: "Map the stakeholder lattice (clinician, admin, IT/security, payer) and surface the real blockers: evidence gaps, risk posture, and unclear ROI story."
    },
    {
      title: "2) Architect",
      description: "Design an evidence-led narrative that makes the economic case unavoidable. Recode messaging for each stakeholder and align claims to regulatory boundaries."
    },
    {
      title: "3) Activate",
      description: "Sequence KOLs, reference sites, and reimbursement pathways. Structure pilots that prove clinical relevance and undeniable financial outcomes."
    }
  ];
  ...
  const services = [
    {
      ...
      description: "Translate clinical proof into stakeholder belief and economic inevitability.",
    ...
    {
      title: "GTM & Funnels",
      description: "Provider/payer pathways, KOL motions, and enterprise funnels that convert.",
    ...
    {
      title: "Fund Raising",
      description: "Investor belief built on evidence chain, regulatory posture, and reimbursement logic.",
    ...
    },
    {
      ...
      description: "Decisions on pilots, codes, partnerships, and market entry timing — made with conviction.",
  ...
  const testimonials = [
    {
      quote: "We had papers and approvals. Instaura turned that into a value story the hospital CFO signed off on.",
      author: "CEO — MedTech"
    },
    {
      quote: "Our AI claims scared buyers. Reframed as risk reduction, we closed two systems in a quarter.",
      author: "Founder — Digital Health"
    },
    {
      quote: "They redesigned the pilot to prove outcomes and economics together. Procurement moved.",
      author: "COO — Health Platform"
    }
  ];
    ...
    <div className="pt-16 bg-white text-gray-800">
      ...
      <header className="bg-gray-50 px-6 py-3 text-sm">
        <div className="max-w-6xl mx-auto text-gray-600">
          ...
          <span className="text-gray-900 font-medium ml-1">Healthcare & Pharma</span>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Healthcare & Pharma <span className="text-brand-red">Signal</span>. Trust Before Traction.
            </h1>
            <p className="mt-3 text-sm text-gray-500">
              Subsectors: <span className="font-medium text-gray-700">MedTech, Pharma, Digital Health, Biotech, and more</span>
            </p>
            <p className="mt-4 text-lg text-gray-700">
              Healthcare doesn't move on features — it moves on evidence, economics, and trust.
              Signal turns research into reality.
            </p>
          ...
          <div className="group rounded-3xl border-2 border-white/60 p-8 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl hover:scale-105 hover:border-brand-red/30 transition-all duration-500">
            ...
            <ul className="text-sm text-gray-700 space-y-1 list-disc ml-5">
              <li>MedTech with approvals that need adoption signal</li>
              <li>Digital health moving from pilots to paid pathways</li>
              <li>Biotech stories requiring payer/provider belief</li>
              <li>Enterprise health platforms navigating security & procurement</li>
            </ul>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4 text-gray-800">
                <p><strong>Evidence without narrative:</strong> teams lead with studies, not belief. Clinicians nod; buyers stall.</p>
                <p><strong>Regulatory ≠ readiness:</strong> clearance is table stakes, not a go-to-market. The signal for adoption is still missing.</p>
                <p><strong>Who pays? Who benefits?:</strong> value stories fail when the economic buyer and clinical user aren't aligned.</p>
                <p><strong>Data trust:</strong> privacy, compliance, and security concerns drown out product value when not framed as signal.</p>
              </div>
              <div className="group bg-white rounded-3xl border-2 border-white/60 p-8 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl hover:scale-105 hover:border-brand-red/30 transition-all duration-500">
                ...
                <ul className="list-disc ml-5 space-y-2 text-gray-700">
                  <li>Clinical claims that don't translate into procurement logic</li>
                  <li>Pilots designed to prove features, not economic outcomes</li>
                  <li>Messaging aimed at clinicians while the budget holder is a CFO or payer</li>
                  <li>"AI in healthcare" pitches that trigger risk, not reassurance</li>
                </ul>
                <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden mt-4">
                  <div className="h-full bg-gradient-to-r from-brand-red to-red-600 w-0 group-hover:w-full transition-all duration-700"></div>
                </div>
      ...
      <ScrollReveal>
        <section id="services" className="px-6 py-10 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Services for Healthcare & Pharma</h2>
          ...
          <div className="max-w-6xl mx-auto rounded-2xl border p-8 shadow-sm bg-white hover:shadow-md hover:scale-105 transition-all duration-300">
            <div className="md:flex md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-gray-600 mt-2">See how Signal changed outcomes in Healthcare & Pharma.</p>
              </div>
              <div className="flex flex-wrap gap-2 mt-4 md:mt-0">
                <Link href="/insights?vertical=healthcare-pharma">
      ...
      <section className="px-6 py-14 bg-brand-dark text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-300">You don't need more features or another study — you need the one architecture that buyers, clinicians, and payers believe.</p>
