...
export default function CaseStudy12() {
  ...
  const relatedResources: RelatedResource[] = [
    ...
    {
        "href": "/contact?ask_ai=Tell%20me%20about%20%234%3A%20The%20Signal%20Sprint",
        "type": "Clarity Series",
        "title": "#4: The Signal Sprint",
    ...
    <div className="pt-16 bg-white">
      ...
      <div className="bg-gray-50 px-6 py-3 text-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto text-gray-600 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Case Study #12</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          ...
          >
            ...
            <h1 className="mt-4 text-4xl md:text-6xl font-bold font-raleway leading-tight" data-testid="heading-title">
              Market Access Strategy as Signal
            </h1>
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-4xl leading-relaxed" data-testid="text-subtitle">
              Fragmented market access across geographies diluted inevitability. We built a signal-led strategy—multi-market expansion became inevitable.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
              ...
              <p className="mt-2 font-semibold text-white" data-testid="text-stage">Series B Growth Phase</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
              <p className="text-xs text-gray-400 uppercase tracking-wide">Region</p>
              <p className="mt-2 font-semibold text-white" data-testid="text-region">India & Southeast Asia</p>
            </div>
          </motion.div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              A mid-stage healthcare company had achieved product-market fit with a diagnostics platform but was struggling with market access. Multiple geographies required different regulatory clearances, payer alignments, and distribution partnerships. The founder was constantly firefighting — shifting from regulatory hurdles to pricing battles to investor updates. The result: no coherent growth story.
            </p>
            <blockquote className="border-l-4 border-brand-red pl-6 italic text-gray-800 text-xl my-8" data-testid="quote-conundrum">
              "We were chasing approvals and partners, but we weren't sending a clear signal of inevitability to the market."
            </blockquote>
          </div>
        </motion.div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="font-semibold text-lg text-gray-900">Scalability Concerns</h3>
                <p className="mt-3 text-gray-700">Investors began to worry about scalability beyond one geography.</p>
              </motion.div>
              <motion.div 
                {...caseStudyAnimations.card}
                whileHover={caseStudyAnimations.card.whileHover}
                className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm will-change-transform"
              >
                <h3 className="font-semibold text-lg text-gray-900">Execution Silos</h3>
                <p className="mt-3 text-gray-700">Without a cohesive strategy, teams worked in silos and diluted execution velocity.</p>
              </motion.div>
              <motion.div 
                {...caseStudyAnimations.card}
                whileHover={caseStudyAnimations.card.whileHover}
                className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm will-change-transform"
              >
                <h3 className="font-semibold text-lg text-gray-900">Competitive Pressure</h3>
                <p className="mt-3 text-gray-700">Global competitors with weaker products but sharper market access strategies were pulling ahead.</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-700">
            We built a Signal-Led Market Access Strategy under a fractional strategist model:
          </p>
          <div className="mt-10 grid lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Identified that fragmented execution was leaking credibility.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold">Step 2</p>
              <h3 className="mt-3 text-xl font-bold text-gray-900">Strategic Sprint</h3>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Prioritized 3 access milestones (regulatory clearance, payer partnership, distributor alignment).
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Reframed external communications to lead with inevitability signals — "approved, reimbursable, and distributable."
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Installed a quarterly signal sprint framework with clear ownership across regulatory, sales, and partnerships.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Regulatory Clearances</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-regulatory">2 New</p>
                <p className="mt-2 text-gray-700">Countries approved in 6 months</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Payer Partnerships</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-payer">Major</p>
                <p className="mt-2 text-gray-700">40% faster adoption unlocked</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Valuation Uplift</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-valuation">~30%</p>
                <p className="mt-2 text-gray-700">Follow-on funding interest</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Team Alignment</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-team">Improved</p>
                <p className="mt-2 text-gray-700">Reduced duplication, faster execution</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              The company's market access narrative transformed from "piecemeal execution" to "inevitable multi-market expansion." Investors, partners, and customers aligned behind the new clarity, and the company entered its Series B raise with confidence.
            </p>
          </div>
          <figure className="mt-10 bg-gradient-to-br from-gray-50 to-white p-10 rounded-2xl border border-gray-200 shadow-sm">
            <blockquote className="text-xl italic text-gray-800 leading-relaxed" data-testid="quote-outcome">
              "We had the product. We had the approvals. But no one believed the story. Instaura gave us clarity — suddenly, the market saw inevitability."
            </blockquote>
      ...
      <section className="bg-black text-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-300 leading-relaxed">
            Your strategy isn't just operations. It's a signal. Architect it before you scale.
          </p>
