...
export default function CaseStudy23() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="pt-16 bg-white">
      ...
      <div className="bg-gray-50 px-6 py-3 text-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto text-gray-600 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Case Study #23</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          ...
          <motion.div {...caseStudyAnimations.hero.title}>
            ...
            <h1 className="mt-4 text-4xl md:text-6xl font-bold font-raleway leading-tight" data-testid="heading-title">
              Velocity Funnels for Real Estate Sales
            </h1>
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-4xl leading-relaxed" data-testid="text-subtitle">
              Premium residential projects built, but sales cycles painfully slow. Marketing brought traffic but not conversions. Brokers controlled narrative, eroding margins.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-5 backdrop-blur-sm hover:bg-white/10 transition">
              ...
              <p className="mt-2 font-semibold text-white" data-testid="text-stage">Pre-Series B (Scaling Across Multiple Projects)</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-5 backdrop-blur-sm hover:bg-white/10 transition">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        <motion.div {...caseStudyAnimations.section}>
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              A mid-sized real estate developer had built premium residential projects, but sales cycles were painfully slow. Marketing teams focused on high ad spends and generic campaigns, which brought traffic but not conversions. Brokers controlled the narrative, eroding margins, and buyers perceived the projects as "good but not urgent."
            </p>
            <blockquote className="border-l-4 border-brand-red pl-6 italic text-gray-800 text-xl my-8" data-testid="quote-conundrum">
              "We had interest. But no urgency. Buyers lingered, brokers dictated — and sales velocity stalled."
            </blockquote>
          </div>
        </motion.div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <motion.div {...caseStudyAnimations.section}>
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="font-semibold text-lg text-gray-900">Weak Project Cash Flows</h3>
                <p className="mt-3 text-gray-700">Without faster sales cycles, project cash flows were weak.</p>
              </motion.div>
              <motion.div 
                className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm"
                whileHover={caseStudyAnimations.card.whileHover}
              >
                <h3 className="font-semibold text-lg text-gray-900">Investor Confidence Undermined</h3>
                <p className="mt-3 text-gray-700">Investor confidence in expansion plans was undermined.</p>
              </motion.div>
              <motion.div 
                className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm"
                whileHover={caseStudyAnimations.card.whileHover}
              >
                <h3 className="font-semibold text-lg text-gray-900">Brand Reduced to Mid-Tier Developer</h3>
                <p className="mt-3 text-gray-700">Market perception risked reducing the brand to "one more mid-tier developer."</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24">
        <motion.div {...caseStudyAnimations.section}>
          ...
          <p className="mt-4 text-lg text-gray-700">
            We built a Signal-First Funnel & GTM Playbook:
          </p>
          <div className="mt-10 grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Identified leakage points in the buyer journey — weak urgency, scattered narratives.
              </p>
            </motion.div>
            <motion.div 
              className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm"
            ...
            >
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Created a scarcity-driven funnel: limited unit releases, phased price escalations, curated showcases.
              </p>
            </motion.div>
            <motion.div 
              className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm"
            ...
            >
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Reframed sales campaigns from "availability" → "inevitable movement."
              </p>
            </motion.div>
            <motion.div 
              className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm"
            ...
            >
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Designed digital + offline GTM focused on credibility signals (community proof, early adopters, testimonials).
              </p>
            </motion.div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow lg:col-span-2">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Installed sales scripts and proof dashboards for the client team.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Sales Velocity</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-sales-velocity">65%</p>
                <p className="mt-2 text-gray-700">Of units sold in the first 60 days of launch</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Cash Flow Acceleration</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-cash-flow">-9 Months</p>
                <p className="mt-2 text-gray-700">Faster unit absorption → project break-even reduced by 9 months</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Investor Outcome</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-investor">Unlocked</p>
                <p className="mt-2 text-gray-700">Expansion financing unlocked with stronger sales proof</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Market Signal</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-market-signal">Inevitable</p>
                <p className="mt-2 text-gray-700">Projects perceived as "inevitable sell-outs"</p>
              </div>
            </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        <motion.div {...caseStudyAnimations.section}>
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              The company reframed itself from availability-driven developer to scarcity-driven community builder. Funnels became signals, compressing cycles and amplifying valuation narratives.
            </p>
          </div>
          <figure className="mt-10 bg-gradient-to-br from-gray-50 to-white p-10 rounded-2xl border border-gray-200 shadow-sm">
            <blockquote className="text-xl italic text-gray-800 leading-relaxed" data-testid="quote-outcome">
              "We stopped pushing availability. Instaura showed us how to build funnels of inevitability. Suddenly, sales velocity took care of itself."
            </blockquote>
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-6">
              <Link href="/white-papers" className="block group">
                <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="mt-3 text-gray-700 text-sm leading-relaxed">
                    Understanding how funnels without signal architecture fail to capture value.
                  </p>
                </div>
              </Link>
              <Link href="/white-papers" className="block group">
                <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="mt-3 text-gray-700 text-sm leading-relaxed">
                    How visual design without signal architecture fails to create market movement.
                  </p>
                </div>
              </Link>
              <Link href="/clarity-series" className="block group">
                <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="mt-3 text-gray-700 text-sm leading-relaxed">
                    Understanding the signal dynamics that drive purchase velocity.
                  </p>
                </div>
              </Link>
            </div>
      ...
      <section className="bg-black text-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-300 leading-relaxed">
            Your projects don't sell on availability. They sell on inevitability. Architect funnels that move buyers before brokers.
          </p>
