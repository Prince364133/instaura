...
export default function CaseStudy48() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="pt-16 bg-white">
      ...
      <div className="bg-gray-50 px-6 py-3 text-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto text-gray-600 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Case Study #48</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          ...
          >
            ...
            <h1 className="mt-4 text-4xl md:text-6xl font-bold font-raleway leading-tight" data-testid="heading-title">
              Strategic Clarity for BFSI Scale
            </h1>
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-4xl leading-relaxed" data-testid="text-subtitle">
              Fintech company raised solid Series A and achieved steady transaction growth. But as they prepared for Series B, investors flagged strategic drift. Trying to expand into lending, insurance aggregation, and cross-border payments all at once.
            </p>
          </motion.div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              A fintech company raised a solid Series A and achieved steady transaction growth across India and the Middle East. The metrics looked good on the surface—revenue was climbing, users were growing, and the product was stable. But as the team prepared for their Series B raise, investors flagged a critical issue: strategic drift.
            </p>
            <p>
              The company was trying to do everything at once. Lending. Insurance aggregation. Cross-border payments. Each initiative made sense in isolation, but together, they created confusion. Investors couldn't build conviction around nine different bets. Regulatory partners were unclear on what the company actually stood for. And the market saw them as a jack-of-all-trades, master of none.
            </p>
            <blockquote className="border-l-4 border-brand-red pl-6 italic text-gray-800 text-xl my-8" data-testid="quote-conundrum">
              "We were chasing every opportunity. But no one saw us as inevitable anywhere."
            </blockquote>
          </div>
        </motion.div>
      </section>
          ...
          >
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-6">
              <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-lg text-gray-900">Lack of Clarity Weakened Investor Confidence</h3>
                <p className="mt-3 text-gray-700">Without a singular narrative, investors couldn't see the company as inevitable in any one market.</p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-lg text-gray-900">Regulatory Partners Confused</h3>
                <p className="mt-3 text-gray-700">Regulators struggled to categorize the company, slowing down approvals and creating compliance friction.</p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-lg text-gray-900">Risk of Being Jack-of-All-Trades</h3>
                <p className="mt-3 text-gray-700">Without focus, the company risked becoming a generalist in a market that rewards category leaders.</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-700">
            We built a Strategic Clarity Framework to transform drift into inevitability:
          </p>
          <div className="mt-10 grid lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Conducted a strategic audit to identify which initiatives were creating signal and which were creating noise. The diagnosis: too many bets were diluting the core narrative.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Reframed positioning from "fintech platform with multiple products" to "compliance-cleared payments backbone for emerging markets." A singular, inevitable story.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Ran quarterly strategy sprints to consolidate initiatives, align team execution, and ensure every move reinforced the new narrative.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Rebuilt pitch materials, board decks, and investor communications to signal clarity, focus, and inevitability—not breadth and experimentation.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Embedded as fractional strategy leadership to ensure the strategic reset wasn't a one-time event, but an ongoing discipline.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                ...
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-investor">$25M Series B</p>
                <p className="mt-2 text-gray-700">Raised at improved multiple</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Execution Velocity</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-execution">9→3 initiatives</p>
                <p className="mt-2 text-gray-700">-67% reduction, improved focus</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Regulatory Alignment</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-regulatory">Fast-tracked</p>
                <p className="mt-2 text-gray-700">Licenses approved in record time</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Market Positioning</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-positioning">2 Geographies</p>
                <p className="mt-2 text-gray-700">Compliance-cleared payments backbone</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              The company transitioned from noisy expansion to inevitable payments infrastructure. Investors stopped questioning the strategy and started believing in the category. Regulatory approvals accelerated because the company's focus became clear. The team aligned around a singular mission, and execution velocity increased dramatically.
            </p>
            <p>
              The reset wasn't about building different products—it was about signaling a different story. And that story made all the difference. From scattered bets to strategic inevitability. From drift to clarity. From noise to signal.
            </p>
          </div>
          <figure className="mt-10 bg-gradient-to-br from-gray-50 to-white p-10 rounded-2xl border border-gray-200 shadow-sm">
            <blockquote className="text-xl italic text-gray-800 leading-relaxed" data-testid="quote-outcome">
              "We thought we needed more products to scale. Instaura showed us we needed fewer products and clearer signals. Once we made that shift, investors, regulators, and the market all aligned. The Series B became inevitable."
            </blockquote>
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-6">
              <Link href="/white-papers/why-vc-deal-flow-depends-on-signal" className="block group">
                <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-md hover:shadow-xl bg-white  hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="mt-3 text-gray-700 text-sm leading-relaxed">
                    How strong signals create investor conviction and unlock capital.
                  </p>
                </div>
              </Link>
              <Link href="/white-papers/signal-velocity-and-market-movement" className="block group">
                <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-md hover:shadow-xl bg-white  hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="mt-3 text-gray-700 text-sm leading-relaxed">
                    How clarity accelerates market response and competitive positioning.
                  </p>
                </div>
              </Link>
              <Link href="/contact?ask_ai=Tell%20me%20about%20%2315%3A%20Strategic%20Reset%20Frameworks" className="block group">
                <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-md hover:shadow-xl bg-white  hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  <div className="flex items-center gap-2 text-brand-red">
                  ...
                  <p className="mt-3 text-gray-700 text-sm leading-relaxed">
                    How to transform strategic drift into focused inevitability.
                  </p>
                </div>
              </Link>
            </div>
