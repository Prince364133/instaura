...
export default function CaseStudy15() {
  ...
  const relatedResources: RelatedResource[] = [
    ...
    {
        "href": "/contact?ask_ai=Tell%20me%20about%20%2311%3A%20Why%20DeepTech%20Dies%20in%20the%20Lab%20Without%20Signal",
        "type": "Clarity Series",
        "title": "#11: Why DeepTech Dies in the Lab Without Signal",
