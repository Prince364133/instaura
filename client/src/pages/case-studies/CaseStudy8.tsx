  ...
  const relatedResources: RelatedResource[] = [
    {
        "href": "/",
        "type": "White Paper",
        "title": "#1: Pricing as Signal",
        "label": "White Paper"
    },
    {
        "href": "/contact?ask_ai=Tell%20me%20about%20%236%3A%20Why%20More%20SKUs%20Kill%20Growth",
        "type": "White Paper",
        "title": "#6: Why More SKUs Kill Growth",
        "label": "White Paper"
    },
    {
        "href": "/contact?ask_ai=Tell%20me%20about%20%2315%3A%20Why%20Strategy%20Isn't%20About%20Doing%20More",
        "type": "Clarity Series",
        "title": "#15: Why Strategy Isn't About Doing More",
    ...
    <div className="pt-16 bg-white">
      ...
      <div className="bg-gray-50 px-6 py-3 text-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto text-gray-600 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Case Study #8</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          ...
          >
            ...
            <h1 className="mt-4 text-4xl md:text-6xl font-bold font-raleway leading-tight" data-testid="heading-title">
              Pricing & Assortment as Signal
            </h1>
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-4xl leading-relaxed" data-testid="text-subtitle">
              Bloated catalog, inconsistent pricing, eroding brand value. We cut 40% of SKUs and reset pricing as inevitability signals—transforming perception and margins.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
              ...
              <p className="mt-2 font-semibold text-white" data-testid="text-stage">Pre-Series B (Scaling)</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              The D2C brand had achieved steady growth online, but profitability remained elusive. Their catalog was bloated with SKUs that diluted focus, and pricing was inconsistent. Discounting had become habitual, eroding brand value. Investors flagged weak unit economics, and customers were confused about whether the brand stood for quality or affordability.
            </p>
            <blockquote className="border-l-4 border-brand-red pl-6 italic text-gray-800 text-xl my-8" data-testid="quote-conundrum">
              "We were selling everything to everyone — and in the process, signaling nothing."
            </blockquote>
          </div>
        </motion.div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="font-semibold text-lg text-gray-900">Commoditization Risk</h3>
                <p className="mt-3 text-gray-700">Without a sharper strategy, the brand risked being commoditized.</p>
              </motion.div>
              <motion.div 
                {...caseStudyAnimations.card}
                whileHover={caseStudyAnimations.card.whileHover}
                className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm will-change-transform"
              >
                <h3 className="font-semibold text-lg text-gray-900">Investor Trust</h3>
                <p className="mt-3 text-gray-700">Pricing confusion undermined investor trust in sustainability.</p>
              </motion.div>
              <motion.div 
                {...caseStudyAnimations.card}
                whileHover={caseStudyAnimations.card.whileHover}
                className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm will-change-transform"
              >
                <h3 className="font-semibold text-lg text-gray-900">Operational Inefficiency</h3>
                <p className="mt-3 text-gray-700">The bloated assortment created operational inefficiency and wasted working capital.</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-700">
            We implemented a Signal-Driven Strategy Sprint with focus on precision:
          </p>
          <div className="mt-10 grid lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="mt-4 text-gray-700 leading-relaxed">
                Identified which SKUs actually transmitted brand strength vs. noise.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold">Step 2</p>
              <h3 className="mt-3 text-xl font-bold text-gray-900">Pricing Signal Reset</h3>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Anchored prices to brand inevitability, not competitor discounts.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold">Step 3</p>
              <h3 className="mt-3 text-xl font-bold text-gray-900">Assortment Rationalization</h3>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Cut 40% of underperforming SKUs and doubled down on hero products.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold">Step 4</p>
              <h3 className="mt-3 text-xl font-bold text-gray-900">Narrative Reframe</h3>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Communicated the reset to customers and investors as "curated, inevitable brand expansion."
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">SKU Reduction</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-sku">-40%</p>
                <p className="mt-2 text-gray-700">With improved margins</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Gross Margin</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-margin">+22%</p>
                <p className="mt-2 text-gray-700">Increased profitability</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-500 uppercase tracking-wide">Customer Perception</p>
                <p className="mt-3 text-3xl font-extrabold text-gray-900" data-testid="metric-nps">+18 pts</p>
                <p className="mt-2 text-gray-700">NPS improved after reset</p>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                ...
                <p className="mt-2 text-gray-700">Stronger interest secured</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              The company transitioned from a "discount-heavy, noisy brand" to a lean, premium challenger. Pricing and assortment became inevitability signals that convinced both customers and investors.
            </p>
          </div>
          <figure className="mt-10 bg-gradient-to-br from-gray-50 to-white p-10 rounded-2xl border border-gray-200 shadow-sm">
            <blockquote className="text-xl italic text-gray-800 leading-relaxed" data-testid="quote-outcome">
              "We thought more products meant more growth. Instaura showed us that clarity — in pricing and assortment — was the real growth signal."
            </blockquote>
      ...
      <section className="bg-black text-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-300 leading-relaxed">
            Your pricing and assortment aren't operational decisions. They're signals. Architect them with precision.
          </p>
